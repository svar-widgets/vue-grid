export function getData() {
	...
	const countries = [
		{ id: 1, label: "Poland", flag: "\u{1F1F5}\u{1F1F1}", code: "PL" },
		{ id: 2, label: "Brasil", flag: "\u{1F1E7}\u{1F1F7}", code: "BR" },
		{ id: 3, label: "USA", flag: "\u{1F1FA}\u{1F1F8}", code: "US" },
		{ id: 4, label: "Germany", flag: "\u{1F1E9}\u{1F1EA}", code: "DE" },
		{ id: 5, label: "France", flag: "\u{1F1EB}\u{1F1F7}", code: "FR" },
		{ id: 6, label: "Italy", flag: "\u{1F1EE}\u{1F1F9}", code: "IT" },
		{ id: 7, label: "Spain", flag: "\u{1F1EA}\u{1F1F8}", code: "ES" },
		{ id: 8, label: "Portugal", flag: "\u{1F1F5}\u{1F1F9}", code: "PT" },
		{ id: 9, label: "Switzerland", flag: "\u{1F1E8}\u{1F1ED}", code: "CH" },
		{ id: 10, label: "Ukraine", flag: "\u{1F1FA}\u{1F1E6}", code: "UA" },
		{ id: 11, label: "Austria", flag: "\u{1F1E6}\u{1F1F9}", code: "AT" },
	];
